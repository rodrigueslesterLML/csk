...
const Contact = () => {
    ...
    const formSubmit = (e) => {
        e.preventDefault();
        alert( ` My Name is ${data.fullname}. My number is ${data.mobile}`);
    };

    return (
        <>
            <div className="my-5">
                <h1 className="contacthead text-center"> Contact Us </h1>
            </div>
                    ...
                    <div className="col-md-6 col-10 mx-auto">
                        <form onSubmit={formSubmit}>
                            ...
                            <div className="mb-3">
                                ...
                                <input type="number" className="form-control" id="exampleFormControlInput1" name="mobile" value={data.mobile} onChange={InputEvent} placeholder="Enter your phone number" />
                            </div>
                            <div className="mb-3">
